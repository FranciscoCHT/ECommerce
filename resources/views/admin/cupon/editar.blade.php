<!-- Modal -->
<div class="modal fade validarEdicion onShowEdicionCupon onShowEditarSelect" tabindex="-1" role="dialog" id="modalEditar_{{ $cupon->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title">Modificar cupón</h5>
            </div>
