...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="date" name="fecha_creacion" id="fecha_creacion" class="form-control" value="{{old('fecha_creacion')}}" autocomplete="off" required/>
    </div>
</div>
<div class="form-group">
    <label for="fecha_termino" class="col-lg-3 control-label">Fecha Término</label>
    <div class="col-lg-8">
        <input type="date" name="fecha_termino" id="fecha_termino" class="form-control" value="{{old('fecha_termino')}}" autocomplete="off"/>
    </div>
</div>